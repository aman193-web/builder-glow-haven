  ...
  return (
    <div className="min-h-screen bg-white font-lato">
        ...
        <nav className="relative z-10 flex justify-between items-center px-28 py-5 max-lg:px-8 max-lg:py-4">
          <div className="flex items-center gap-10">
            ...
            <div className="hidden lg:flex items-center gap-10">
              <a
                href="#demos"
                className="text-white text-base font-normal hover:text-blue-500 transition-colors"
              >
                Demos
              </a>
              <a
          ...
          <div className="flex items-center gap-10">
            <a
              href="#login"
              className="hidden lg:block text-white text-base font-normal hover:text-blue-500 transition-colors"
            >
              Login
            </a>
            ...
            <div className="flex justify-between items-end mb-16 max-lg:flex-col max-lg:gap-8">
              <div className="flex-1 max-w-[617px]">
                <h1 className="text-white text-[60px] font-normal leading-[72px] tracking-[-1.2px] mb-6 max-lg:text-4xl max-lg:leading-tight">
                  Transform your{" "}
                  <span className="font-bold">⚡ Business Processes</span> with
                  Voice AI
                </h1>
                <p className="text-gray-200 text-base leading-6 mb-6 max-w-[488px]">
                  AI that listens, understands, and responds like your best team
                  member—across sales, support, and beyond.
                </p>
              ...
              <div className="flex flex-col items-end gap-6 max-lg:items-center">
                ...
                <div className="relative">
                  ...
                  <p className="text-white/60 text-base font-medium text-center mt-4 text-sm">
                    Talk to Takallam
                  </p>
                </div>
      ...
      <section className="py-36 bg-gray-50">
        <div className="max-w-[1280px] mx-auto px-8">
          <div className="text-center mb-16">
            <div className="text-blue-500 text-base font-medium mb-3">
              What Can Takallam Do?
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-base leading-6">
                Resolve routine support requests instantly, escalate complex
                ones.
              </p>
            </div>
      ...
      {[
        {
          ...
          description:
            "With our platform, you can easily track sales and manage inventory, making it easier to keep track of your transactions and products.",
          ...
          <div className="max-w-[1280px] mx-auto px-8">
            <div className="flex lg:items-center gap-16 max-lg:flex-col">
              <div className="flex-1 pl-5">
                <div className="text-black/40 text-base font-semibold tracking-[-0.32px] mb-10">
                  {feature.badge}
                </div>
      ...
      <section className="relative bg-slate-800 py-24">
        {/* Curved divider */}
        <svg
          className="absolute top-0 left-0 w-full h-17"
          viewBox="0 0 1440 68"
          fill="none"
        >
          <path
            d="M1440 51.3595C815.174 92.4472 219.656 47.8691 0 20.4441V0H1440V23.9345V51.3595Z"
            fill="white"
          />
        </svg>
              ...
              {[
                {
                  ...
                  avatar:
                    "https://api.builder.io/api/v1/image/assets/TEMP/c740c3e21a12c9f4838d3f6f3d8fd52b223cf3e6?width=120",
                },
                {
                  ...
                  avatar:
                    "https://api.builder.io/api/v1/image/assets/TEMP/5fa0d558fbe8a9558777a9e5cde11c94df08a88b?width=120",
                },
                {
                  name: "Wade Warren",
                  role: "Founder, Creaty",
                  ...
                  <ul className="space-y-3">
                    {["Link 1", "Link 2", "Link 3", "Link 4"].map((link) => (
                      <li key={link}>
                        <a
                          href="#"
                          className="text-gray-600 text-base hover:text-blue-500 transition-colors"
                        >
                          {link}
                        </a>
                      </li>
