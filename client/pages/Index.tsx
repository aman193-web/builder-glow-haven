        ...
        <nav className="relative z-10 flex justify-between items-center px-28 py-5 max-lg:px-8 max-lg:py-4">
          <div className="flex items-center gap-10">
            ...
            <div className="hidden lg:flex items-center gap-10">
              <a href="#demos" className="text-white text-base font-normal hover:text-blue-500 transition-colors">Demos</a>
              <a href="#about" className="text-white text-base font-normal hover:text-blue-500 transition-colors">About</a>
              <a href="#pages" className="text-white text-base font-normal hover:text-blue-500 transition-colors">Pages</a>
              <a href="#contact" className="text-white text-base font-normal hover:text-blue-500 transition-colors">Contact</a>
            </div>
          </div>
          
          {/* CTA */}
          <div className="flex items-center gap-10">
            <a href="#login" className="hidden lg:block text-white text-base font-normal hover:text-blue-500 transition-colors">Login</a>
                ...
                <div key={i}>
                  ...
                  <ul className="space-y-3">
                    {['Link 1', 'Link 2', 'Link 3', 'Link 4'].map(link => (
                      <li key={link}>
                        <a href="#" className="text-gray-600 text-base hover:text-blue-500 transition-colors">
                          {link}
                        </a>
                      </li>
                    ))}
